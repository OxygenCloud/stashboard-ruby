...
module Stashboard
  ...
  class Stashboard
    ...
    def services
      response = JSON.parse(@client.get("/admin/api/v1/services").body)
    ...
    def service(service_id)
      response = @client.get("/admin/api/v1/services/#{service_id}")
    ...
    def delete_service(service_id)
      response = @client.delete("/admin/api/v1/services/#{service_id}")
      return JSON.parse(response.body)
    end
    ...
    def levels
      response = JSON.parse(@client.get("/admin/api/v1/levels").body)
    ...
    def events(service_id, options = {})
      response = JSON.parse(@client.get("/admin/api/v1/services/#{service_id}/events", options).body)
    ...
    def current_event(service_id)
      response = @client.get("/admin/api/v1/services/#{service_id}/events/current")
      return JSON.parse(response.body)
    end
    ...
    def event(service_id, event_sid)
      response = @client.get("/admin/api/v1/services/#{service_id}/events/#{event_sid}")
      return JSON.parse(response.body)
    end
    ...
    def statuses
      response = JSON.parse(@client.get("/admin/api/v1/statuses").body)
    ...
    def status(status_id)
      response = @client.get("/admin/api/v1/statuses/#{status_id}")
      return JSON.parse(response.body)
    end
    ...
    def status_images
      response = JSON.parse(@client.get("/admin/api/v1/status-images").body)
